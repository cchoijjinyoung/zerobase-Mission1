        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id="bookmarkGroupName" name="bookmarkGroupName" value="<%=bookmarkGroup.getName()%>">
                </td>
            </tr>
            <tr>
                <th>순서</th>
                <td>
                    <input type="text" id="bookmarkGroupSequence" name="bookmarkGroupSequence" value="<%=bookmarkGroup.getSequence()%>">
                </td>
            </tr>
            </tbody>
        </table>
